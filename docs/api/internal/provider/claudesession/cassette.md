---
title: internal/provider/claudesession/cassette
...
```go
import "github.com/jbcom/radioactive-ralph/internal/provider/claudesession/cassette"
```
...
<a name="Cassette"></a>
## type [Cassette](<https://github.com/jbcom/radioactive-ralph/blob/main/internal/provider/claudesession/cassette/cassette.go#L39-L63>)
...
<a name="Load"></a>
### func [Load](<https://github.com/jbcom/radioactive-ralph/blob/main/internal/provider/claudesession/cassette/cassette.go#L101>)
...
### func \(\*Cassette\) [Save](<https://github.com/jbcom/radioactive-ralph/blob/main/internal/provider/claudesession/cassette/cassette.go#L89>)
...
<a name="Frame"></a>
## type [Frame](<https://github.com/jbcom/radioactive-ralph/blob/main/internal/provider/claudesession/cassette/cassette.go#L66-L83>)
...
<a name="Recorder"></a>
## type [Recorder](<https://github.com/jbcom/radioactive-ralph/blob/main/internal/provider/claudesession/cassette/recorder.go#L25-L41>)
...
### func [NewRecorder](<https://github.com/jbcom/radioactive-ralph/blob/main/internal/provider/claudesession/cassette/recorder.go#L45>)
...
### func \(\*Recorder\) [Close](<https://github.com/jbcom/radioactive-ralph/blob/main/internal/provider/claudesession/cassette/recorder.go#L98>)
...
### func \(\*Recorder\) [Start](<https://github.com/jbcom/radioactive-ralph/blob/main/internal/provider/claudesession/cassette/recorder.go#L80>)
...
### func \(\*Recorder\) [Stdin](<https://github.com/jbcom/radioactive-ralph/blob/main/internal/provider/claudesession/cassette/recorder.go#L87>)
...
### func \(\*Recorder\) [Stdout](<https://github.com/jbcom/radioactive-ralph/blob/main/internal/provider/claudesession/cassette/recorder.go#L91>)
...
### func \(\*Recorder\) [Wait](<https://github.com/jbcom/radioactive-ralph/blob/main/internal/provider/claudesession/cassette/recorder.go#L94>)
