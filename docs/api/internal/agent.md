...
<a name="Agent"></a>
## type [Agent](<https://github.com/jbcom/radioactive-ralph/blob/main/internal/agent/agent.go#L124-L164>)
...
<a name="Start"></a>
### func [Start](<https://github.com/jbcom/radioactive-ralph/blob/main/internal/agent/agent.go#L167>)
...
<a name="Agent.Done"></a>
### func \(\*Agent\) [Done](<https://github.com/jbcom/radioactive-ralph/blob/main/internal/agent/agent.go#L425>)
...
### func \(\*Agent\) [ExitErr](<https://github.com/jbcom/radioactive-ralph/blob/main/internal/agent/agent.go#L454>)
...
<a name="Agent.Kill"></a>
### func \(\*Agent\) [Kill](<https://github.com/jbcom/radioactive-ralph/blob/main/internal/agent/agent.go#L430>)
...
### func \(\*Agent\) [Output](<https://github.com/jbcom/radioactive-ralph/blob/main/internal/agent/agent.go#L407>)
...
<a name="Agent.PID"></a>
### func \(\*Agent\) [PID](<https://github.com/jbcom/radioactive-ralph/blob/main/internal/agent/agent.go#L457>)
...
### func \(\*Agent\) [TerminateAndWait](<https://github.com/jbcom/radioactive-ralph/blob/main/internal/agent/agent.go#L435>)
...
<a name="Agent.Wait"></a>
### func \(\*Agent\) [Wait](<https://github.com/jbcom/radioactive-ralph/blob/main/internal/agent/agent.go#L444>)
...
### func \(\*Agent\) [WriteInput](<https://github.com/jbcom/radioactive-ralph/blob/main/internal/agent/agent.go#L413>)
...
<a name="Options"></a>
## type [Options](<https://github.com/jbcom/radioactive-ralph/blob/main/internal/agent/agent.go#L62-L116>)
