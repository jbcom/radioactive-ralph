...
- [ ] [WAIT] Land the 1 open PR: #307 (name the dependency that makes a task
      unreachable -- the gap the SECOND dogfooding pass found). Auto-merge
      ARMED. Hash-prefixed deliberately: guard 9 extracts `#[0-9]{3}` from
      THIS line.
