...
When the operator invokes `/green-ralph` in Claude Code, this skill hands off to
...
`radioactive_ralph stop --variant green`. For live status, `radioactive_ralph status --variant green`.
