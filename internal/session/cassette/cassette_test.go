...
import (
	...
	"github.com/jbcom/radioactive-ralph/internal/session/cassette"
)
...
// through session.Spawn and verifies the client observes the same
// frames.
func TestRecordThenReplayRoundTrip(t *testing.T) {
	fake := buildBin(t, "github.com/jbcom/radioactive-ralph/internal/session/internal/fakeclaude")
	replayer := buildBin(t, "github.com/jbcom/radioactive-ralph/internal/session/cassette/replayer")
	...
	// ── Phase 2: REPLAY via session.Spawn ────────────────────────
